...
//      casting object to set of strings
//        Object r = requestMap.get("roles");
//        Set<String> userRoles = new HashSet<>();
//        if (r instanceof List<?>) {
//            for (Object obj : (List<?>)r){
//                if (obj instanceof String){
//                    String rr = (String) obj;
//                    if (!rr.equals(User.USER_ROLE_USER) &&  !rr.equals(User.USER_ROLE_ADMIN) && !rr.equals(User.USER_ROLE_SUPER_ADMIN))
//                        return new ApiResponseHandler("please provide valid role values, can be only: "+User.USER_ROLE_USER+", "+User.USER_ROLE_ADMIN+" and "+User.USER_ROLE_SUPER_ADMIN, null, ResponseStatus.BAD_REQUEST, ResponseStatusCode.BAD_REQUEST, true);
//                    userRoles.add(rr);
//                }
//            }
//        }
